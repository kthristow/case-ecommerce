...
const Navbar = () => {
    ...
    const isAdmin = false;
    return (
        <nav className="sticky z-[100] h-14 inset-x-0 top-0 w-full bored-b border-gray-200 bg-white/75 backdrop-blur-lg transition-all">
            <MaxWidthWrapper>
                    ...
                    <div className="h-full flex items-center space-x-4">
                        {user ? (
                            <>
                                ...
                                <Link href="/conficure/upload" className={buttonVariants({
                                    size: 'sm',
